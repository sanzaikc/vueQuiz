<template>
    <div>
                    ...
                    <validation-observer ref="observer" v-slot="{ handleSubmit }" >
                        <b-form @submit.prevent="handleSubmit(createQuiz)">   
                            ...
                            <div class="my-3 d-flex">
                                <img v-if="quiz.image" :src="url" alt="" height="150" class="mx-auto rounded-lg border border-success">
                            </div>

                            <b-button type="submit" variant="outline-primary" class="w-100" :disabled="isCreating">
                            {{ isCreating ? 'Creating' : 'Create' }} <b-spinner v-if="isCreating" small type="grow" class="ml-2"></b-spinner>
                            </b-button>
        ...
        <div class="row">
            <quiz-card v-for="quiz in quizzes" :key="quiz.id" :quiz="quiz" class="mx-2 col-md-4"></quiz-card>
        </div>
    </div>
</template>
<script>
